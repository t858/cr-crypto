...
const INITIAL_TICKER_DATA = [
    ...
    { symbol: "BTC", price: "97,450.00", change: "+4.20%", isUp: true },
    { symbol: "ETH", price: "3,420.50", change: "+2.15%", isUp: true },
    { symbol: "SOL", price: "210.15", change: "+8.90%", isUp: true },
];
    ...
    useEffect(() => {
        const fetchCryptoPrices = async () => {
            try {
                ...
                // Silently fallback to static mock ticker data
            }
        };
