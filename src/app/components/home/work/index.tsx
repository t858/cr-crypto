      ...
      <div className='container'>
        <div className='text-center mb-14'>
          ...
          <p className='text-lightpurple max-w-2xl mx-auto md:text-lg font-normal md:leading-8'>
            Getting started with copy trading is simple. Connect your wallet, choose a verified expert trader, and enable auto-copy to start earning like the professionals — all on a secure and intuitive platform.
          </p>
        </div>
