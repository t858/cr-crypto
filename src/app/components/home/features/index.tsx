        ...
        <div className=' gap-x-4 gap-y-4 relative z-10'>
          ...
          <div className='mb-10'>
            ...
            <h2 className='font-semibold mb-6 text-center max-w-2xl mx-auto sm:leading-14 capitalize'>
              The Most Trusted Copy Trading Platform
            </h2>
            <p className='lg:text-lg font-normal text-lightpurple text-center max-w-2xl mx-auto '>
              Discover powerful tools designed to help you automatically copy elite traders and grow your crypto portfolio — trusted by 50,000+ investors worldwide.
            </p>
          </div>
          {/* Column-2 */}
          <div>
