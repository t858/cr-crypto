    ...
    <section id='contact' className='scroll-mt-14'>
      <div className='container'>
        <div className='relative'>
              ...
              <div className='mx-0 my-2.5 w-full'>
                <button
                  ...
                  className={`border leading-none px-6 text-lg font-medium py-4 rounded-full 
                    ${!isFormValid || loader
                      ? 'bg-primary border-primary text-black cursor-not-allowed opacity-50'
                      : 'bg-primary border-primary text-black hover:bg-transparent hover:text-primary cursor-pointer'
                    }`}>
                  Submit
                </button>
              </div>
          ...
          {showThanks && (
            <div className='text-black bg-primary rounded-full px-4 text-lg mb-4.5 mt-1 absolute flex items-center gap-2'>
