  ...
  return (
    <div className='fixed bottom-8 right-8 z-999'>
      <div className='flex items-center gap-2.5'>
        <Link
          href='/signup'
          className='hidden lg:block bg-primary text-black hover:bg-primary/15 hover:text-white text-sm font-medium px-4 py-3.5 leading-none rounded-lg text-nowrap'>
          Email us @..
        </Link>
        {isVisible && (
          <div
